...
/***/ function(module, exports, __webpack_require__) {
	...
	var _AjaxService = __webpack_require__(39);
	...
	var AppForm = function () {
		function AppForm(props) {
			...
			(0, _classCallCheck3.default)(this, AppForm);

			this.props = (0, _assign2.default)({}, this.props, props);
		...
		(0, _createClass3.default)(AppForm, [{
			key: 'setFields',
			...
			key: 'setValidField',
			value: function setValidField(name) {
				var resValid = true;
			...
			key: 'validAllFields',
			value: function validAllFields() {
				var _this2 = this;

				var valid = 0;

				$.each(this.fields, function (name, el) {
					if (!_this2.setValidField(name)) {
						valid++;
					}
				});
			...
			value: function sendForm() {
				...
				if (this.validForm === true) {
					Ajax.post('/saveForm', this.fields).then(function (res) {
						if (res.data.STATUS == 1) {
							var text = '',
							    title = _this3.props.goodTitle || '';
							if (_this3.props.goodMessage != undefined && _this3.props.goodMessage.length > 0) {
								text = _this3.props.goodMessage;
							} else {
