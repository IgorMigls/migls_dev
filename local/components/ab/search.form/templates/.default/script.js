...
var _arrays = __webpack_require__("../../node_modules/shallow-equal/arrays/index.js");

var _arrays2 = _interopRequireDefault(_arrays);

var _reactAutowhatever = __webpack_require__("../../node_modules/react-autowhatever/dist/index.js");

var _reactAutowhatever2 = _interopRequireDefault(_reactAutowhatever);

var _theme = __webpack_require__("../../node_modules/react-autosuggest/dist/theme.js");
...
module.exports = __webpack_require__("../../node_modules/react-autosuggest/dist/Autosuggest.js").default;
...
var _sectionIterator = __webpack_require__("../../node_modules/section-iterator/dist/index.js");

var _sectionIterator2 = _interopRequireDefault(_sectionIterator);

var _reactThemeable = __webpack_require__("../../node_modules/react-themeable/dist/index.js");

var _reactThemeable2 = _interopRequireDefault(_reactThemeable);

var _SectionTitle = __webpack_require__("../../node_modules/react-autowhatever/dist/SectionTitle.js");

var _SectionTitle2 = _interopRequireDefault(_SectionTitle);

var _ItemsList = __webpack_require__("../../node_modules/react-autowhatever/dist/ItemsList.js");
...
var _compareObjects = __webpack_require__("../../node_modules/react-autowhatever/dist/compareObjects.js");
...
var _Item = __webpack_require__("../../node_modules/react-autowhatever/dist/Item.js");
...
module.exports = __webpack_require__("../../node_modules/react-autowhatever/dist/Autowhatever.js").default;
...
/***/ "./components/ab/search.form/app/app.js":
/***/ (function(module, exports, __webpack_require__) {
...
var renderSuggestion = function renderSuggestion(suggestion) {
	return React.createElement(
		...
		React.createElement(
			...
			suggestion.IMG instanceof Object && suggestion.IMG.hasOwnProperty('src') && React.createElement('img', { src: suggestion.IMG.src })
		),
		React.createElement(
			'div',
			{ className: 'title_product_s' },
			suggestion.TITLE
		),
		React.createElement(
			'div',
			{ className: 'price_product_s' },
			suggestion.hasOwnProperty('SKU') && suggestion.SKU.hasOwnProperty('PRICES') && React.createElement(
				'span',
				{ className: 'prices_search_block' },
				suggestion.SKU.PRICES.PRICE,
				' ',
				React.createElement(
					'span',
					{ className: 'b-rouble' },
...
var Autosuggest = function (_AutosuggestBase) {
	(0, _inherits3.default)(Autosuggest, _AutosuggestBase);
...
var Search = function (_React$Component) {
	...
	function Search(props) {
		...
		_this3.$input = $('#' + props.inputId);

		_this3.load = false;
		_this3.onChange = _this3.onChange.bind(_this3);
		_this3.onSuggestionsFetchRequested = _this3.onSuggestionsFetchRequested.bind(_this3);
		_this3.onSuggestionsClearRequested = _this3.onSuggestionsClearRequested.bind(_this3);
		_this3.onSuggestionSelected = _this3.onSuggestionSelected.bind(_this3);
		return _this3;
	}
	...
	(0, _createClass3.default)(Search, [{
		...
		value: function onSuggestionsFetchRequested(_ref2) {
			...
			var searchResult = (0, _debounce2.default)(this.getResult.bind(this), 300);
			searchResult(value);
		}
	}, {
		...
		key: 'getResult',
		value: function getResult(query) {
			var _this4 = this;

			if (!this.load) {
				this.load = true;
				Rest.get('/getResult', { params: { q: query, shop: this.props.shop } }).then(function (res) {
					var data = res.data.DATA;
					_this4.setState({ results: data });
					_this4.load = false;
				});
			}
		}
		...
		value: function onSuggestionSelected(ev, _ref3) {
		...
		value: function render() {
			...
			return React.createElement(
				'form',
				{ method: 'GET', action: this.props.action, autoComplete: 'off' },
				React.createElement(
					'div',
					{ className: 'b-header-search__center b-ib' },
				...
				React.createElement(
					'button',
					{ className: 'b-button b-button_green float_r', name: 's', type: 'submit' },
					'\u041D\u0430\u0439\u0442\u0438'
				)
			);
		}
...
$(function () {
	var $section = $('.top_search_section');
	if ($section.length > 0) {
		var prop = {
		...
		ReactDOM.render(React.createElement(Search, prop), $section[0]);
	}
});
