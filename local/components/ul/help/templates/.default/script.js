...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/home/bitrix/ext_www/ul.profitweb.biz/local/components/ul/help/app/app.js'; // import 'es6-shim';
	...
	$(function () {
		ReactDOM.render(React.createElement(
			...
			React.createElement(_Help2.default, {
				__source: {
					fileName: _jsxFileName,
					lineNumber: 13
				},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _storeShape = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/home/bitrix/ext_www/ul.profitweb.biz/local/components/ul/help/app/Help.js';
	...
	var HelpApp = function (_React$Component) {
		(0, _inherits3.default)(HelpApp, _React$Component);

		function HelpApp(props) {
			(0, _classCallCheck3.default)(this, HelpApp);
			return (0, _possibleConstructorReturn3.default)(this, (HelpApp.__proto__ || (0, _getPrototypeOf2.default)(HelpApp)).call(this, props));
		}

		(0, _createClass3.default)(HelpApp, [{
			...
			value: function render() {
				...
				var first = [];
				$.each(Help.Sections, function (k, el) {
					var elements = [];
					if (el.elements != undefined && el.elements.length > 0) {

						elements = el.elements.map(function (elementItem) {
							return React.createElement(
								'li',
								{ className: 'acord__item-2', __source: {
										fileName: _jsxFileName,
										lineNumber: 29
									},
									__self: _this2
								...
								React.createElement(
									'ul',
									{ className: 'acord__sub-2 animated fadeInUp', __source: {
											fileName: _jsxFileName,
											lineNumber: 31
										},
										__self: _this2
									...
									React.createElement(
										'li',
										{ className: 'acord__item-3', __source: {
												fileName: _jsxFileName,
												lineNumber: 32
											},
											__self: _this2
										},
										React.createElement('span', { dangerouslySetInnerHTML: { __html: elementItem.DETAIL_TEXT }, __source: {
												fileName: _jsxFileName,
												lineNumber: 33
											},
											__self: _this2
					...
					first.push(React.createElement(
						'li',
						{ className: 'acord__item', key: el.ID, __source: {
								fileName: _jsxFileName,
								lineNumber: 43
							},
							__self: _this2
						...
						React.createElement(
							'a',
							{ href: 'javascript:', className: 'acord__link', __source: {
									fileName: _jsxFileName,
									lineNumber: 44
								},
								__self: _this2
						...
						elements.length > 0 ? React.createElement(
							'ul',
							{ className: 'acord__sub animated fadeInUp', __source: {
									fileName: _jsxFileName,
									lineNumber: 47
								},
								__self: _this2
				...
				return React.createElement(
					'div',
					{ className: 'b-help-acord-wrapper', __source: {
							fileName: _jsxFileName,
							lineNumber: 58
						},
						__self: this
					...
					React.createElement(
						'div',
						{ className: 'b-help-acord', __source: {
								fileName: _jsxFileName,
								lineNumber: 59
							},
							__self: this
	...
	exports.default = (0, _reactRedux.connect)(_controller.HelperCtrl.mapStateToProps, _controller.HelperCtrl.mapDispatchToProps)(HelpApp);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.S + $export.F * !__webpack_require__(78), 'Object', {defineProperty: __webpack_require__(74).f});
...
/***/ function(module, exports, __webpack_require__) {
	...
	__webpack_require__(73)(IteratorPrototype, __webpack_require__(113)('iterator'), function(){ return this; });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var global        = __webpack_require__(66)
	  , hide          = __webpack_require__(73)
	  , Iterators     = __webpack_require__(98)
	  , TO_STRING_TAG = __webpack_require__(113)('toStringTag');
	...
	module.exports = {
	  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
	    function(test, buggy, set){
	      try {
	        set = __webpack_require__(71)(Function.call, __webpack_require__(131).f(Object.prototype, '__proto__').set, 2);
	        set(test, []);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.HelperCtrl = exports.rootReducer = undefined;

	var _extends2 = __webpack_require__(144);

	var _extends3 = _interopRequireDefault(_extends2);

	var _ajaxService = __webpack_require__(149);

	var _ajaxService2 = _interopRequireDefault(_ajaxService);

	var _redux = __webpack_require__(1);

	var _is_js = __webpack_require__(184);
		...
		Help: function Help() {
			...
			switch (action.type) {
				case 'GET_MAIN_SECTIONS':
					return (0, _extends3.default)({}, state, { Sections: action.Sections });
				default:
					return state;
			}
		}
		...
		mapDispatchToProps: function mapDispatchToProps(dispatch) {
			return {
				getSections: function getSections() {
					...
					Ajax.get('/getSections', { params: { sectionParent: parent } }).then(function (result) {
	...
	var Ajax = function Ajax() {
		...
		this.params = {
			...
			transformResponse: [function (data) {
				...
				var text = 'Внутренняя ошибка сервера';
				if (data.STATUS == 0) {
