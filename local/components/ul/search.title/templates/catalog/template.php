...
<div id="<? echo $CONTAINER_ID ?>">
	<form action="<? echo $arResult["FORM_ACTION"] ?>">
		...
		<div class="b-header-search__center b-ib">
			<input id="<? echo $INPUT_ID ?>" type="text" name="q" value="" size="40" class="b-header-search__input"
			       maxlength="50" autocomplete="off" placeholder="Например, говядина для шашлыка, 3 кг"/>
		</div>
