...
<div class="order_step_1">
	...
	<div class="order1__radio" ng-init="adr = 'N'" ng-show="Profiles.length > 0">
	...
	<div class="order1__form">
		...
		<form method="post" ng-submit="addressFormStep()" novalidate name="formPropProfile">
			...
			<label class="form__label" ng-show="savedAddress == 1 || (adr == 'Y' && selectAddress != 0)">
				<button type="button" ng-click="deleteAddress(choseAddress)"
					class="b-button b-button_check b-button_green b-button_big b-button_del b-button_width">
					Удалить адрес
				</button>
			</label>
			<label class="form__label" ng-show="formPropProfile.$valid && adr != 'Y' && savedAddress != 1">
				<button type="button" ng-click="saveAddressDB()"
				        class="b-button b-button_check b-button_green b-button_big b-button_width">
					Сохранить адрес
				</button>
			</label>
			<label class="form__label">
				<input type="text" ng-model="Properties.PHONE.VALUE"
					...
					class="form__input form__input_middle form__input_tooltip" ng-required="true" name="PHONE">
			</label>
			...
			<?endif;?>
			<button type="submit" class="b-button b-button_green b-button_check b-button_big b-button_width">Дальше</button>
		</form>
	</div>
