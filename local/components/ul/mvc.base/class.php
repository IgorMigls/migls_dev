...
class BaseComponent extends \CBitrixComponent
{
    ...
    public function onPrepareComponentParams($arParams)
    {
	    ...
	    $arParams['URLS'] = [];
	    foreach ($arParams['SEF_URL_TEMPLATES'] as $code => $value) {
		    $arParams['URLS'][strtoupper($code).'_URL'] = $arParams['SEF_FOLDER'].$arParams['SEF_URL_TEMPLATES'][$code];
	    }
...
//        	Debug::toLog($e->getTraceAsString());
//        	Debug::toLog($e->getLine());
