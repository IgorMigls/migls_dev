...
class Manager
{
	...
	const COMPONENT_PARAMS_FOLDER = '/online1c/cmp_params';
	...
	public function getResult()
	{
		...
		$result = ['STATUS' => 1, 'ERRORS' => null, 'DATA' => null, 'SYSTEM' => []];
	 ...
	 * @return array
	 */
	public static function getComponentParams($name, array $params)
	{
		$request = \Bitrix\Main\Context::getCurrent()->getRequest();
		$cache = new DataCache(86400, self::COMPONENT_PARAMS_FOLDER, $name);
		if($cache->isValid() && $request->get('clear_cache') != 'Y'){
