...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/home/bitrix/www/local/modules/ab.tools/asset/js/htmlEditor/app.js';
	...
	var AppCode = function (_React$Component) {
		(0, _inherits3.default)(AppCode, _React$Component);

		function AppCode(props) {
			(0, _classCallCheck3.default)(this, AppCode);
			...
			_this.setLineNum = _this.setLineNum.bind(_this);
			_this.setLang = _this.setLang.bind(_this);
			_this.setCodeText = _this.setCodeText.bind(_this);
			_this.insertCodeToEditor = _this.insertCodeToEditor.bind(_this);
			return _this;
		}

		(0, _createClass3.default)(AppCode, [{
			key: 'setLang',
			value: function setLang(ev) {
				var newVal = this.lang.filter(function (el) {
			...
			key: 'setLineNum',
			value: function setLineNum(ev) {
				this.setState({ showLineNum: !this.state.showLineNum });
			}
		}, {
			key: 'setCodeText',
			value: function setCodeText(ev) {
				this.setState({ codeText: ev.target.value });
			}
		}, {
			key: 'insertCodeToEditor',
			value: function insertCodeToEditor(dialog) {
				var _this2 = this;
				...
				var htmlCode = '<pre class="' + classPre + '"><code class="' + lang + '">';
				...
				dialog.Close();
				setTimeout(function () {
					_this2.BXEditor.SetContent(_this2.BXEditor.GetContent());
					_this2.BXEditor.ReInitIframe();
				}, 50);
			}
		}, {
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								...
								React.createElement('input', { className: 'checkbox macro-param-input', id: 'macro-param-linenumbers',
