/**
 * Created by GrandMaster on 25.06.17.
 */
/** @var o React */
/** @var o ReactDOM */
/** @var o is */
...
export default class Autosuggest extends React.Component {
	...
	constructor({ alwaysRenderSuggestions }) {
		...
		this.resetHighlightedSuggestionOnMouseLeave = this.resetHighlightedSuggestionOnMouseLeave.bind(this);
	...
	render() {
		...
		const autowhateverInputProps = Object.assign({}, inputProps, {
			onFocus: event => {
				if (
