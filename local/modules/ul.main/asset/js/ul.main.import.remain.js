...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/home/bitrix/www/local/modules/ul.main/asset/js/app.remain.js';

	var _Preloader = __webpack_require__(87);

	var _Preloader2 = _interopRequireDefault(_Preloader);

	var _RestService = __webpack_require__(93);

	var _RestService2 = _interopRequireDefault(_RestService);

	var _Fields = __webpack_require__(129);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Ajax = new _RestService2.default({
		baseURL: '/actions/admin/remain'
	});

	var RemainMain = function (_React$Component) {
		(0, _inherits3.default)(RemainMain, _React$Component);

		function RemainMain(props) {
			(0, _classCallCheck3.default)(this, RemainMain);

			var _this = (0, _possibleConstructorReturn3.default)(this, (RemainMain.__proto__ || (0, _getPrototypeOf2.default)(RemainMain)).call(this, props));

			_this.state = {
				fileList: [{ label: ' - Выбрать файл - ', id: null }],
				processFiles: []
			};
			_this.currentFile = {};

			_this.setFile = _this.setFile.bind(_this);
			_this.startImport = _this.startImport.bind(_this);
			return _this;
		}

		(0, _createClass3.default)(RemainMain, [{
			key: 'setFile',
			value: function setFile(arFile) {
			...
			value: function startImport() {
				...
				Ajax.post('/addFileToQueue', { file: this.currentFile.id }).then(function (result) {
					if (result.data.STATUS == 1) {
						swal('', 'Файл добавлен в очередь импорта.', 'success');
						_this2.getProcessFiles();
					}
				});
			}
		}, {
			key: 'getProcessFiles',
			value: function getProcessFiles() {
				var _this3 = this;

				Ajax.get('/getProcessFiles').then(function (res) {
					if (res.data.STATUS == 1) {
						_this3.setState({ processFiles: res.data.DATA });
					}
				});
			}
		}, {
			...
			value: function componentDidMount() {
				...
				Ajax.get('/getFileList').then(function (res) {
					if (res.data.STATUS == 1) {
						(function () {
							var files = _this4.state.fileList;
							res.data.DATA.forEach(function (el, k) {
								files.push(el);
							});

							_this4.setState({ fileList: files });
						})();
					}
				});
			...
			value: function render() {
				...
				console.info(this.state.processFiles);
				return React.createElement(
					'div',
					{ className: 'remail_import_wrap', __source: {
							fileName: _jsxFileName,
							lineNumber: 74
						},
						__self: this
					},
					this.state.processFiles.length == 0 && React.createElement(
						'div',
						{
							__source: {
								fileName: _jsxFileName,
						...
						'\xA0\xA0',
						React.createElement(_Fields.SelectField, { values: this.state.fileList, onChange: this.setFile, __source: {
								fileName: _jsxFileName,
								lineNumber: 79
							},
							__self: this
						...
						'\xA0\xA0',
						React.createElement('input', { type: 'button', className: 'adm-btn-save', value: '\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C', onClick: this.startImport, __source: {
								fileName: _jsxFileName,
								lineNumber: 80
							},
							__self: this
					...
					this.state.processFiles.length > 0 && React.createElement(
						'table',
						{ className: 'adm-list-table', __source: {
								fileName: _jsxFileName,
								lineNumber: 85
							},
							__self: this
						...
						React.createElement(
							...
							React.createElement(
								'tr',
								{ className: 'adm-list-table-header', __source: {
										fileName: _jsxFileName,
										lineNumber: 87
									},
									__self: this
								...
								React.createElement(
									'td',
									{ className: 'adm-list-table-cell adm-list-table-cell-sort', __source: {
											fileName: _jsxFileName,
											lineNumber: 88
										},
										__self: this
									...
									React.createElement(
										'div',
										{ className: 'adm-list-table-cell-inner', __source: {
												fileName: _jsxFileName,
												lineNumber: 89
											},
											__self: this
						...
						React.createElement(
							...
							this.state.processFiles.map(function (el) {
								return React.createElement(
									'tr',
									{ className: 'adm-list-table-cell adm-list-table-popup-block', __source: {
											fileName: _jsxFileName,
											lineNumber: 108
										},
										__self: _this5
									...
									React.createElement(
										'td',
										{ className: 'adm-list-table-cell', __source: {
												fileName: _jsxFileName,
												lineNumber: 109
											},
											__self: _this5
									...
									React.createElement(
										...
										el.IN_PROCESS === 'Y' ? 'В процессе' : 'Завершен'
									)
								);
							})
						)
	...
	$(function () {
		ReactDOM.render(React.createElement(RemainMain, {
			__source: {
				fileName: _jsxFileName,
				lineNumber: 130
			},
			__self: this
		}), BX('remain_file_import'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jsxFileName = '/home/bitrix/www/local/modules/ab.tools/asset/js/preloader/Preloader.js';

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Preloader = function (_React$Component) {
		(0, _inherits3.default)(Preloader, _React$Component);
		...
		(0, _createClass3.default)(Preloader, [{
			...
			value: function render() {
				...
				return React.createElement(
					...
					this.props.overlay === true ? React.createElement('div', { className: 'r_ajax_overlay', __source: {
							fileName: _jsxFileName,
							lineNumber: 29
						},
						__self: this
					...
					React.createElement(
						...
						React.createElement(
							...
							React.createElement(
								'div',
								{ id: 'floatingBarsG', className: 'ajax_left', __source: {
										fileName: _jsxFileName,
										lineNumber: 32
									},
									__self: this
								},
								React.createElement('div', { className: 'blockG', id: 'rotateG_01', __source: {
										fileName: _jsxFileName,
										lineNumber: 33
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_02', __source: {
										fileName: _jsxFileName,
										lineNumber: 34
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_03', __source: {
										fileName: _jsxFileName,
										lineNumber: 35
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_04', __source: {
										fileName: _jsxFileName,
										lineNumber: 36
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_05', __source: {
										fileName: _jsxFileName,
										lineNumber: 37
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_06', __source: {
										fileName: _jsxFileName,
										lineNumber: 38
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_07', __source: {
										fileName: _jsxFileName,
										lineNumber: 39
									},
									__self: this
								}),
								React.createElement('div', { className: 'blockG', id: 'rotateG_08', __source: {
										fileName: _jsxFileName,
										lineNumber: 40
									},
									__self: this
							...
							React.createElement(
								'span',
								{ className: 'load_text', __source: {
										fileName: _jsxFileName,
										lineNumber: 42
									},
									__self: this
								},
								this.props.text ? this.props.text : 'Загрузка...'
							)
						)
					)
				);
	...
	var Loader = function () {
		...
		(0, _createClass3.default)(Loader, [{
			...
			value: function component(props) {
				return React.createElement(Preloader, (0, _extends3.default)({}, props, {
					__source: {
						fileName: _jsxFileName,
						lineNumber: 64
					},
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sweetalert = __webpack_require__(94);
			...
			this.params = {
				...
				transformResponse: [function (data) {
					...
					if (data == null) {
						...
						(0, _sweetalert2.default)({ title: "", text: errTxt, type: "error" });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide$isDescendant$getTopMargin$fadeIn$fadeOut$fireClick$stopEventPropagation = __webpack_require__(95);

	/*
	 * Handy utilities
	 */

	var _extend$hexToRgb$isIE8$logStr$colorLuminance = __webpack_require__(96);

	/*
	 *  Handle sweetAlert's DOM elements
	 */

	var _sweetAlertInitialize$getModal$getOverlay$getInput$setFocusStyle$openModal$resetInput$fixVerticalPosition = __webpack_require__(97);

	// Handle button events and keyboard events

	var _handleButton$handleConfirm$handleCancel = __webpack_require__(100);

	var _handleKeyDown = __webpack_require__(101);

	var _handleKeyDown2 = _interopRequireWildcard(_handleKeyDown);

	// Default values

	var _defaultParams = __webpack_require__(98);

	var _defaultParams2 = _interopRequireWildcard(_defaultParams);

	var _setParameters = __webpack_require__(102);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hexToRgb = __webpack_require__(96);

	var _removeClass$getTopMargin$fadeIn$show$addClass = __webpack_require__(95);
	...
	var _injectedHTML = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _colorLuminance = __webpack_require__(96);

	var _getModal = __webpack_require__(97);

	var _hasClass$isDescendant = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _stopEventPropagation$fireClick = __webpack_require__(95);

	var _setFocusStyle = __webpack_require__(97);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _isIE8 = __webpack_require__(96);

	var _getModal$getInput$setFocusStyle = __webpack_require__(97);

	var _hasClass$addClass$removeClass$escapeHtml$_show$show$_hide$hide = __webpack_require__(95);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.SelectField = exports.TextField = exports.ErrorField = undefined;
	...
	var _jsxFileName = '/home/bitrix/www/local/modules/ab.tools/asset/js/form/Fields/index.js';
	...
	var Validator = {
		isValid: function isValid(value, data) {
			var _this = this;
			...
			if (is.array(data)) {
				data.forEach(function (code) {
					...
					if (!is.regexp(code) && is.function(_this[code])) {

						if (_this[code]() === false) _this.noValid++;
					} else if (is.regexp(code) === true) {

						if (_this.regExp(code) === false) _this.noValid++;
					}
				});
			} else if (is.string(data)) {
				if (is.function(this[data]) && !is.regexp(data)) {

					if (this[data]() === false) this.noValid++;
				} else if (is.function(this[data]) && is.regexp(data)) {

					if (this.regExp(data) === false) this.noValid++;
				}
			}
	...
	var ErrorField = function (_React$Component) {
		(0, _inherits3.default)(ErrorField, _React$Component);

		function ErrorField(props) {
			(0, _classCallCheck3.default)(this, ErrorField);
			return (0, _possibleConstructorReturn3.default)(this, (ErrorField.__proto__ || (0, _getPrototypeOf2.default)(ErrorField)).call(this, props));
		}

		(0, _createClass3.default)(ErrorField, [{
			key: 'render',
			value: function render() {
				var _this3 = this;
				...
				var classWrap = (0, _classnames2.default)('error_field_wrap', this.props.className);
				return React.createElement(
					'span',
					{ className: classWrap, __source: {
							fileName: _jsxFileName,
							lineNumber: 106
						},
						__self: this
					},
					this.props.data.map(function (el, k) {
						return React.createElement(
							'span',
							{ className: 'error_field_item', key: 'error_field_' + k, __source: {
									fileName: _jsxFileName,
									lineNumber: 108
								},
								__self: _this3
	...
	var TextField = function (_React$Component2) {
		(0, _inherits3.default)(TextField, _React$Component2);

		function TextField(props) {
			(0, _classCallCheck3.default)(this, TextField);

			var _this4 = (0, _possibleConstructorReturn3.default)(this, (TextField.__proto__ || (0, _getPrototypeOf2.default)(TextField)).call(this, props));
		...
		(0, _createClass3.default)(TextField, [{
			...
			value: function transform(value) {
				...
				if (this.props.transform instanceof Array) {
					this.props.transform.forEach(function (code) {
						if (Transform.hasOwnProperty(code) && is.function(Transform[code])) {
							newValue = Transform[code](newValue);
						}
					});
				}
			...
			key: 'getErrorMsg',
			value: function getErrorMsg(errors) {
				var data = [];
				if (is.string(errors)) {
				...
				return React.createElement(ErrorField, { data: data, show: !this.state.valid, __source: {
						fileName: _jsxFileName,
						lineNumber: 196
					},
					__self: this
			...
			value: function render() {
				var fieldClass = '';
				if (this.state.valid !== true) fieldClass = (0, _classnames2.default)(this.props.className, 'error_field_', this.props.errorClass);else fieldClass = this.props.className;

				return React.createElement(
					'span',
					{ className: 'field_form', __source: {
							fileName: _jsxFileName,
							lineNumber: 207
						},
						__self: this
					},
					React.createElement('input', (0, _extends3.default)({}, this.props, { value: this.state.value, onChange: this.change, className: fieldClass, __source: {
							fileName: _jsxFileName,
							lineNumber: 208
						},
						__self: this
	...
	var SelectField = function (_React$Component3) {
		(0, _inherits3.default)(SelectField, _React$Component3);

		function SelectField(props) {
			(0, _classCallCheck3.default)(this, SelectField);

			var _this5 = (0, _possibleConstructorReturn3.default)(this, (SelectField.__proto__ || (0, _getPrototypeOf2.default)(SelectField)).call(this, props));

			_this5.state = {
				selected: { id: null, label: null, index: null }
			};

			_this5.setSelected = _this5.setSelected.bind(_this5);
			return _this5;
		}

		(0, _createClass3.default)(SelectField, [{
			key: 'setSelected',
			value: function setSelected(ev) {
				var index = this.getIndexById(ev.target.value);
				var selected = this.props.values[index];
			...
			value: function getIndexById(id) {
				var arValues = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

				var index = null;
				if (arValues.length == 0) arValues = this.props.values;

				if (id != undefined) {
					arValues.forEach(function (el, k) {
						if (el.id == id) {
							index = k;
						}
					});
			...
			value: function render() {
				...
				return React.createElement(
					'select',
					(0, _extends3.default)({}, this.props, { onChange: this.setSelected, __source: {
							fileName: _jsxFileName,
							lineNumber: 274
						},
						__self: this
					}),
					this.props.values.map(function (el, k) {
						var key = el.id != undefined ? _this6.props.id + el.id : _this6.props.id + k;
						var selected = _this6.props.selected.id === el.id ? 'selected' : null;

						return React.createElement(
							'option',
							{ key: key, selected: selected, value: el.id, __source: {
									fileName: _jsxFileName,
									lineNumber: 279
								},
								__self: _this6
