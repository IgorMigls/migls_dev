<?php namespace Online1c\Iblock\Helpers;
...
class IblockCache
{
	 ...
	 * @param $cacheId
	 */
	public function __construct($cacheId, $ttl = 86400, $dir = '')
	{
		$this->ttl = $ttl;
		...
		$this->dir = '/online1c/orm_iblock'.$dir;
	...
	{
		$this->TagCache->clearByTag($this->getCacheId());
	}
}