...
Class grandmaster_console extends CModule
{
	var $MODULE_ID = 'grandmaster.console';
	var $MODULE_VERSION;
	...
	function __construct()
	{
		...
		$this->MODULE_NAME = Loc::getMessage("AB_CONSOLE_MODULE_NAME");
		$this->MODULE_DESCRIPTION = Loc::getMessage("AB_CONSOLE_MODULE_DESC");

		$this->PARTNER_NAME = getMessage("AB_CONSOLE_PARTNER_NAME");
		$this->PARTNER_URI = getMessage("AB_CONSOLE_PARTNER_URI");
	...
	function DoInstall()
	{
		...
		if ($this->isVersionD7()){
			...
			$APPLICATION->ThrowException(Loc::getMessage("AB_CONSOLE_INSTALL_ERROR_VERSION"));
		}

		$APPLICATION->IncludeAdminFile(Loc::getMessage("AB_CONSOLE_INSTALL"), $this->GetPath()."/install/step.php");
	}
	...
	function DoUninstall()
	{
		...
		$APPLICATION->IncludeAdminFile(Loc::getMessage("AB_CONSOLE_UNINSTALL"), $this->GetPath()."/install/unstep.php");
	}
}
